        ...
        <div class="w-[90%] p-5">
            <form wire:submit='register'>
                <div class="text-left my-5">
                    ...
                    <input wire:model='name' type="text" placeholder="Enter your text"
                ...
                <div class="text-left my-5">
                    ...
                    <input wire:model='password_confirmation' type="password" placeholder="Enter your text"
                        class="w-full my-2 px-4 py-2 border border-[#e0e1dd] text-[#e0e1dd] rounded-md shadow-sm focus:outline-none" />
                    <p class="w-full text-red-500">@error('password_confirmation') {{ $message }} @enderror</p>
                </div>
                <div class="mt-8">
                    <button
                        class="border border-[#e0e1dd] font-medium w-full p-2 rounded-md bg-[#e0e1dd] cursor-pointer hover:opacity-85 transition duration-300 ease-in-out">Register</button>
                </div>
            </form>
